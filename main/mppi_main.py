...
from solver.mppi import MPPIController
...
if __name__ == "__main__":
    ...
    mppi = MPPIController(
        ...
        stage_cost_weight=torch.tensor([cost, cost, 0.0, 1], dtype=torch.float32),  # 스테이지 코스트 가중치
        terminal_cost_weight=torch.tensor([cost, cost, 0.0, 1], dtype=torch.float32),  # 터미널 코스트 가중치
